      ...
      <div className="cv__container">
        ...
        <div className="cv_content">
            ...
            <Reveal
              ...
              component={
                <p>
                  ...
                  great passion in building new products and improving customer
                  relationship during the design on New York - United States.
                </p>
              }
            />
            <Reveal
          ...
          <div className="right">
            <Reveal
              delay=".3"
              component={<div className="cv_headline_default">EXPERIENCE</div>}
            />
              ...
              component={
                <div className="experience_content">
                  ...
                  <div className="description">
                    ...
                    campaigns for new positions. Working with a well-coordinated
                    team as remote work.
                  </div>
                </div>
              }
            ...
            <div className="education_category">
              ...
              <div className="right">
                <Reveal
                  delay=".9"
                  component={<div className="cv_headline_default">AWARDS</div>}
                />
